...
export function FormationFDFP() {
  ...
  const loadTrainings = async () => {
    ...
    try {
      ...
      const [workshopsData, attended, statsData, eligibility] = await Promise.all([
        fetchEligibleTrainingWorkshops(profile.id, 'FDFP'),
        getUserAttendedTrainings(profile.id, 'FDFP'),
        getAnimatedWorkshopStats(profile.id, 'FDFP'),
        checkProEligibility(profile.id, 'FDFP'),
      ]);
  ...
  const hasPublicCertification = profile?.roles?.includes('FDFP_public') || attendedTrainings.has('formation');
  const hasProCertification = profile?.roles?.includes('FDFP_pro') || false;
  const hasTrainerCertification = profile?.roles?.includes('FDFP_trainer') || false;
  const hasInstructorCertification = profile?.roles?.includes('FDFP_instructor') || false;
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Formation FDFP</h1>
        <p className="text-muted-foreground mt-2">
          Votre parcours de formation et certifications FDFP
        </p>
      </div>
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <div className="text-xs text-green-700 font-medium">FDFP</div>
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  <p className="font-semibold mb-1">Animateur FDFP</p>
                  <p className="text-sm">
                    Obtenue en complétant la formation FDFP initiale. Permet d'animer des ateliers
                    grand public.
                  </p>
                </TooltipContent>
              </Tooltip>
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <div className="text-xs text-blue-700 font-medium">FDFP</div>
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  <p className="font-semibold mb-1">Animateur Pro FDFP</p>
                  <p className="text-sm">
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <div className="text-xs text-amber-700 font-medium">FDFP</div>
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  <p className="font-semibold mb-1">Formateur FDFP</p>
                  <p className="text-sm">
                ...
                <TooltipTrigger asChild>
                  ...
                  >
                    ...
                    <div className="text-center space-y-1">
                      ...
                      <div className={`text-xs font-medium ${hasInstructorCertification ? 'text-gray-700' : 'text-muted-foreground'}`}>FDFP</div>
                    </div>
                  </div>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs">
                  <p className="font-semibold mb-1">Instructeur FDFP</p>
                  <p className="text-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
        ...
        <Card className="h-full flex flex-col">
          <CardHeader>
            ...
            <CardDescription>Votre avancement vers FDFP_Pro</CardDescription>
          </CardHeader>
          <CardContent className="flex-1 flex flex-col space-y-4">
            {stats && (
              <>
                ...
                <div className="space-y-3">
                  ...
                  <h4 className="font-semibold text-sm">Prérequis pour FDFP_Pro:</h4>
                  ...
                  {proEligibility && proEligibility.isEligible && !hasProCertification && (
                    <Alert className="border-green-200 bg-green-50">
                      ...
                      <AlertDescription className="text-sm text-green-900">
                        Vous êtes éligible pour la formation FDFP_Pro!
                      </AlertDescription>
                    </Alert>
                  )}
                </div>
      ...
      <div ref={availableTrainingsRef} className="scroll-mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Toutes les formations FDFP actuellement accessibles pour vous
            </CardDescription>
          </CardHeader>
          <CardContent>
            {workshops.length === 0 ? (
